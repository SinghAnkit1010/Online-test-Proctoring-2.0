    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
      ...
      <div className='bg-gray-800 flex flex-col justify-center'>
        <form className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg'>
            ...
            <button className='w-full my-3 py-2 bg-teal-500 shadow-lg shadow-teal-500/50 hover:shadow-teal-500/40 text-white font-semibold rounded-lg'>Login</button>
            <div className="flex justify-center text-gray-400 py-2">
            <p>
              Already have an account? Go to {' '}
              <a className='text-red-400' href="/">Login</a>
            </p>
          </div>
        </form>
      </div>
